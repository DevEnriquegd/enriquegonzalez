          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10 md:gap-12">
            ...
            <div className="flex-1 space-y-6 text-center md:text-left md:order-1">
              ...
              <p className="mt-2 text-base text-slate-600 dark:text-slate-400 max-w-2xl">
                Ingeniero de Computación y Sistemas con enfoque en análisis y
                visualización de datos para entornos reales de negocio. Diseño
                soluciones que integran información, optimizan procesos de
                reporting y mejoran la toma de decisiones mediante Python, SQL y
                Power BI.
              </p>
